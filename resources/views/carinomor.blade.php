          ...
          <div class="php-email-form">
            <h5 class="text-center"> Silahkan screenshoot nomor booking anda</h5>
             <div class="form-group mt-5" >
              @foreach ($kode as $key=> $kode) 
               <h2 class="text-center"><b>{{ $kode->kode}}</b></h2>
                   
               @endforeach
               @foreach ($antrian as $key=> $antrian) 
               
               <h3 class="text-center"><b>{{ $antrian->jenislayanans['layanan']}}</b></h3>
                <h3 class="text-center"><b>{{ $antrian->jams['jam']}}</b></h3>
                <h3 class="text-center"><b>{{ $antrian->tanggal}}</b></h3>
                @endforeach
                </div>
